...
export default function SettingsPage() {
  ...
  return (
    <div className="container mx-auto py-8">
      <h1 className="mb-8 text-3xl font-bold tracking-tight text-foreground">Settings</h1>
      ...
      <Card className="mt-8 bg-amber-50 border-amber-200">
        <CardHeader className="flex flex-row items-center gap-2">
            <AlertTriangle className="h-6 w-6 text-amber-600" data-ai-hint="alert warning" />
            <CardTitle className="text-amber-700">Advanced Settings</CardTitle>
        </CardHeader>
        <CardContent>
